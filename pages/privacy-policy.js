...
const privecypolicy = () => {
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Privacy Policy) refers to spay times.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to spay times, accessible from{" "}
            <a
              href="https://spaytimes.xyz"
      ...
      <ul>
        <li>By email: riyadkhan9904@gmail.com</li>
      </ul>
    </div>
  );
};
